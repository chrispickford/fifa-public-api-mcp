 ...
 */
import { z } from "zod";
import { fifaFetch, expectObject } from "./client.js";
import * as shape from "./shape.js";

/** Fetch an endpoint that must return an object; turns FIFA's `200 null` into a clean error. */
const fetchObject = async (path: string, params: Record<string, string | number | undefined>, language: string) =>
...
function tool<S extends z.ZodRawShape>(
  ...
  description: string,
  schema: S,
  fetcher: (args: any) => Promise<unknown>,
  trim: (payload: any, args: any) => unknown,
): ToolDef {
  return {
    name,
    description,
    ...
    handler: async (args) => {
      ...
      return args.raw ? payload : trim(payload, args);
    },
  };
}
...
export const tools: ToolDef[] = [
  tool(
    ...
    (p, a) => shape.trimCompetitionList(p),
  ),
  tool(
    "get_competition",
    "Get a single competition by its string IdCompetition.",
    { idCompetition: z.string() },
    (a) => fetchObject(`/competitions/${a.idCompetition}`, {}, a.language),
  ...
  tool(
    ...
    { idSeason: z.string() },
    (a) => fetchObject(`/seasons/${a.idSeason}`, {}, a.language),
  ...
  tool(
    ...
    (a) => fetchObject(`/timelines/${a.idCompetition}/${a.idSeason}/${a.idStage}/${a.idMatch}`, {}, a.language),
  ...
  tool(
    ...
    { idCompetition: z.string(), idSeason: z.string(), idStage: z.string(), idMatch: z.string() },
    (a) => fetchObject(`/live/football/${a.idCompetition}/${a.idSeason}/${a.idStage}/${a.idMatch}`, {}, a.language),
  ...
  tool(
    ...
    { idTeam: z.string() },
    (a) => fetchObject(`/teams/${a.idTeam}`, {}, a.language),
    (p) => shape.trimTeam(p),
  ),
  tool(
    "get_stadium",
    ...
    { idStadium: z.string() },
    (a) => fetchObject(`/stadiums/${a.idStadium}`, {}, a.language),
